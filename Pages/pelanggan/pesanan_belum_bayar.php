...
if(sizeof(explode("?",$link)) > 1 ){
    ...
    // menyiapkan query
    $sql = "INSERT INTO pemesanan (ID_Pelanggan,ID_menu,status)
            VALUES (:id_pelanggan,:id_menu,:status)";
        ...
        <section class="container my-3 pt-3 pb-3" >
            ...
            <div class="row row-menu bg-light mb-5pt-4 pb-4 pe-4 ps-4" style="border-radius:10px">
                ...
                <div class="col-8">
                   ...
                   <div class="row">
                        <!-- <div class="col-4 angka d-flex align-items-center">
                        ...
                        <div class="col-6 mt-4">
                            <a href="detail_pembayaran.php?id_pelanggan=<?php echo $id_pelanggan; ?>-id_menu=<?php echo $menu_display["ID_menu"]; ?>" name="proses_pesanan" class="btn tombol2">Proses Pesanan</a>
                        </div>
                   </div>
...
<!--footer-->
    ...
    <!-- <script src="../../Assets/js/script.js"></scripAnda> -->
